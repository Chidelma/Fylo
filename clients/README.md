...
```html
<script src="https://d31ma.github.io/FYLO/version/26.30.06/fylo.js"></script>
```
...
```js
import { createBrowserClient } from 'https://d31ma.github.io/FYLO/version/26.30.06/fylo-web.mjs'
